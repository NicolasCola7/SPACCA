...
public class AdminController{
	...
	public void newPlayer(ActionEvent event)  {
		try {
			root = FXMLLoader.load((new File("FXML/NewPlayer.fxml").toURI().toURL()));
			stage=(Stage)((Node)event.getSource()).getScene().getWindow();
			scene=new Scene(root);
			stage.setScene(scene);
			stage.show();
	...
	public void editExisting(ActionEvent event)  {
		try {
			root = FXMLLoader.load((new File("FXML/EditExisting.fxml").toURI().toURL()));
			stage=(Stage)((Node)event.getSource()).getScene().getWindow();
			scene=new Scene(root);
			stage.setScene(scene);
			stage.show();
	...
	public void standardMatch(ActionEvent event)  {
		try {
			root = FXMLLoader.load((new File("FXML/ClassicGameCreation.fxml").toURI().toURL()));
			stage=(Stage)((Node)event.getSource()).getScene().getWindow();
			scene=new Scene(root);
			stage.setScene(scene);
			stage.show();
	...
	public void tournament(ActionEvent event)  {
		try {
			root = FXMLLoader.load((new File("FXML/TournamentCreation.fxml").toURI().toURL()));
			stage=(Stage)((Node)event.getSource()).getScene().getWindow();
			scene=new Scene(root);
			stage.setScene(scene);
			stage.show();
	...
	public void suspendedGames(ActionEvent event)  {
		try {
			root = FXMLLoader.load((new File("FXML/SuspendedGames.fxml").toURI().toURL()));
			stage=(Stage)((Node)event.getSource()).getScene().getWindow();
			scene=new Scene(root);
			stage.setScene(scene);
			stage.show();
